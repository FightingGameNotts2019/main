...
HERO1 = make_img(pygame.image.load(os.path.join('images', 'hero1.png')).convert())
HERO1L = pygame.transform.flip(HERO1, True, False)

HERO2 = make_img(pygame.image.load(os.path.join('images', 'hero2.png')).convert())
HERO2L = pygame.transform.flip(HERO2, True, False)

HERO3 = make_img(pygame.image.load(os.path.join('images', 'hero3.png')).convert())
HERO3L = pygame.transform.flip(HERO3, True, False)

VILLAIN1 = make_img(pygame.image.load(os.path.join('images', 'villain1.png')).convert())
VILLAIN1L = pygame.transform.flip(VILLAIN1, True, False)

VILLAIN2 = make_img(pygame.image.load(os.path.join('images', 'villain2.png')).convert())
VILLAIN2L = pygame.transform.flip(VILLAIN2, True, False)

VILLAIN3 = make_img(pygame.image.load(os.path.join('images', 'villain3.png')).convert())
...
def stageMenu():
    while True:
        ...
        screen.blit(TextSurf, TextRect)
        #Menu options.
        button("Safari", BUT_XPOS, HEIGHT * 0.42, BUT_WIDTH, BUT_HEIGHT, GREEN, BRIGHT_GREEN, level1)
        button("Forrest", BUT_XPOS, HEIGHT * 0.57, BUT_WIDTH, BUT_HEIGHT, GREEN, BRIGHT_GREEN, level2)
        button("Clouds", BUT_XPOS, HEIGHT * 0.71, BUT_WIDTH, BUT_HEIGHT, GREEN, BRIGHT_GREEN, level3)
        button("Menu", BUT_XPOS, HEIGHT * 0.86, BUT_WIDTH, BUT_HEIGHT, RED, BRIGHT_RED, mainMenu)
